...
# Initial
l = 2 # total length
nx = 191  # number of small elements, try changing this number from 41 to 81 and Run All ... what happens?
dx = l / (nx-1) # width of each element
nt = 250    # number of times the simulations will run, is the number of timesteps we want to calculate
...
# initial disturbance
# plt.plot(numpy.linspace(0, l, nx), u)
# plt.show()
